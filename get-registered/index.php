                  ...
                  <div class="col">
                     ...
                     <div style="display: flex">
                        ...
                        <a style="text-decoration:none"
                           href="/"><span style="color:#5cb46a"> change?</span></a
                           ></label
                           >
         ...
         <section id="salaried-employee">
            ...
            <div class="form-group mt-3">
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="form-group">
                        <select class="selectpicker" id="company-type" name="company-type" data-live-search="true" data-width="auto" 
                           required
            ...
            <div class="form-group mt-3">
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="form-group">
                        <select class="selectpicker" id="bank_name" name="salary_bank_name" data-live-search="true" data-width="auto" data-parsley-errors-container=".errorBlock_salary_bank_name" data-parsley-trigger="blur" required data-parsley-required-message="Bank Name is required" data-none-selected-text="Please select...">
